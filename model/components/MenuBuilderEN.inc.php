...
class MenuBuilderEN
{
	...
	function get_menu_items()
	{
		...
		$sql = 'SELECT CmsCategoryId, FatherId, Name, Url, ListOrder FROM CmsCategory WHERE (SeoName = "referanser" or FatherId = 66) ORDER BY FatherId, ListOrder;';
