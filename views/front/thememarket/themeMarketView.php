				...
				<div class="col-md-12">
					...
					<?if($objPoll){ ?>
						<form name="themeMarketForm" method="POST" action="<?=$SN?>executeThemeMarketAction.html">
				           ...
				           <?} else {?>
				           		<div style="text-align:center; padding:10px 0px 30px 0px;"><a href="javascript:document.themeMarketForm.submit();" class="btn btn-primary" role="button">Vote</a> <a class="btn btn-primary" href="<?=$SN;?>myAccountStart.html"><?=$oT->gL("txtMyAccount")?></a></div>
				           <?}?>
