	...
	<div id="wrapper">
		...
		<div class="ui-helper-clearfix content">
			...
			<div class="content-column-right">
				<?if ($event->getArg('categoriesView') != "") {
						echo $event->getArg('categoriesView');
				}?>
				<?if ($event->getArg('profileCategoriesView') != "") {
						echo $event->getArg('profileCategoriesView');
				}?>				
			...
			<div class="content-column-center">
					...
					<?if ($event->getArg('userStart') != "") {
						echo $event->getArg('userStart');
					}?>
					<?if ($event->getArg('userAddEdit') != "") {
						echo $event->getArg('userAddEdit');
					}?>
					<?if ($event->getArg('userConfirm') != "") {
						echo $event->getArg('userConfirm');
					}?>
					<?if ($event->getArg('passwordAddEdit') != "") {
						echo $event->getArg('passwordAddEdit');
					}?>
					<?if ($event->getArg('passwordConfirm') != "") {
						echo $event->getArg('passwordConfirm');
					}?>
					<?if ($event->getArg('shoppingCartView') != "") {
						echo $event->getArg('shoppingCartView');
					}?>
					<?if ($event->getArg('orderHistoryView') != "") {
						echo $event->getArg('orderHistoryView');
					}?>
					<?if ($event->getArg('orderAddressView') != "") {
						echo $event->getArg('orderAddressView');
					}?>
					<?if ($event->getArg('orderPaymentView') != "") {
						echo $event->getArg('orderPaymentView');
					}?>
				</div> <!-- end .content-column-center -->
