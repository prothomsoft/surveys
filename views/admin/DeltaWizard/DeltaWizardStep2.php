...
<div class="ui-widget formButtons">
	<span class="wizardButton"><a href="javascript:$('#event').val('executeDeltaWizardClose');$('#DeltaId').val('<?=$event->getArg("DeltaId");?>');document.f1.submit();">Zapisz zmiany</a></span>
</div>